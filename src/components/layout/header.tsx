    ...
    <header className="bg-card shadow-sm sticky top-0 z-40">
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        <Link href={`/${lang}`} className="flex items-center gap-2">
          <Image src="/logo.png" alt="TRANSPORTESJADIANI Logo" width={216} height={48} className="h-12 w-auto" />
        </Link>
            ...
            <SheetContent side="left">
              <div className="flex flex-col gap-6 p-6">
                <Link href={`/${lang}`} className="flex items-center gap-2" onClick={() => setIsMobileMenuOpen(false)}>
                  <Image src="/logo.png" alt="TRANSPORTESJADIANI Logo" width={180} height={40} className="h-10 w-auto" />
                </Link>
